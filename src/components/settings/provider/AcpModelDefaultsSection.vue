...
const agentId = computed(() =>
  providerID.value.startsWith('acp:') ? providerID.value.slice('acp:'.length) : null
)
...
<template>
  <div v-if="isACPProvider" class="flex flex-col gap-2" data-test-id="acp-model-defaults">
