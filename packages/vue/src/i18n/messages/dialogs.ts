...
export const dialogMessageDefaults = {
  ...
  importProjectFolder:
    'Import a Claude Design project folder or .zip — the AI converts each screen to OpenPencil.',
  pickFolder: 'Pick folder…',
  pickZip: 'Pick .zip…',
  scanning: 'Scanning project…',
  noScreens: 'No screens found. Pick a folder containing .jsx/.tsx components.',
  screensFound: params('{count} screens found'),
  convertScreens: params('Convert {count} selected'),
  converting: 'Converting with AI…',
  convertDone: 'Conversion started — watch the AI panel for progress.',
  convertFailed: params('Conversion failed: {error}'),
  selectAllScreens: 'Select all',
  clearScreenSelection: 'Clear',
  acpDefaultModels: 'Default models',
  acpPlanModel: 'Plan mode',
  acpBuildModel: 'Build mode',
  acpAutoModel: 'Auto mode',
  acpAgentDefault: 'Agent default',
  acpLoadModels: 'Load models…',
  acpLoadingModels: 'Loading models…',
  acpModelsHint: 'Load the model list from the agent CLI to pick a default model per mode.',
  newTab: 'New tab',
